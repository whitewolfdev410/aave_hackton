...
export const getDesignTokens = (mode: 'light' | 'dark') => {
  ...
  return {
    ...
    palette: {
      ...
      text: {
        primary: getColor('#FFFFFF', '#042e4f'),
      ...
      background: {
        ...
        paper: getColor('#042e4f', '#292E41'),
        surface: getColor('#F7F7F9', '#383D51'),
        surface2: getColor('#F9F9FB', '#042e4f'),
        header: getColor('#042e4f', '#1B2030'),
        disabled: getColor('#EAEBEF', '#EBEBEF14'),
        primary: getColor('#042e4f', '#f8feff'),
      },
      divider: getColor('#004671', '#EBEBEF14'),
      action: {
        active: getColor('#8E92A3', '#EBEBEF8F'),
        hover: getColor('#004671', '#EBEBEF14'),
        selected: getColor('#EAEBEF', '#EBEBEF29'),
        disabled: getColor('#BBBECA', '#EBEBEF4D'),
        disabledBackground: getColor('#083d62', '#EBEBEF1F'),
